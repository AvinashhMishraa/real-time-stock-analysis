...
#----------------------------------------------METHOD-1-------------------------------------------#
snowflake_account = st.secrets["account_literal"]
...
connection_parameters = {
    "account": snowflake_account,                               # <your snowflake account identifier>
    "user": snowflake_username,                                 # <your snowflake username>
    "password": snowflake_password,                             # <your snowflake password>
    "role": "ACCOUNTADMIN",                                     # optional
    # "warehouse": "<your snowflake warehouse>",                # optional
    "database": "cybersyn_financial__economic_essentials",      # optional
    "schema": "cybersyn"                                        # optional
}
...
#_______________________________________________METHOD-2____________________________________________#
